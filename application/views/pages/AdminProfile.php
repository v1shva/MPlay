    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <!-- /.col -->
            ...
            <!-- /.row -->
            <div class="container" scr="assets/css/Admin/profile">
        <div class="row">
      ...
      <!-- <div style="color:#999;" >click here to change profile image</div> -->
                  ...
                  <h4 style="color:#00b1b1;"><?php echo $profile->name;?></h4></span>
      ...
      <div class="col-sm-5 col-xs-6 tital " >Name:</div><div class="col-sm-7 col-xs-6 "><?php echo $profile->name;?></div>
           <div class="clearfix"></div>
      ...
      <div class="col-sm-5 col-xs-6 tital " >Date Of Birth:</div><div class="col-sm-7"><?php echo $profile->birthday;?></div>
